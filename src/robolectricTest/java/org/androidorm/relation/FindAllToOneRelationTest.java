...
public class FindAllToOneRelationTest extends TestBase {
    ...
    public void testSimpleFind() throws AndroidOrmException {
        ...
        // find
        assertContains(em.findAll(SimpleTestClass.class), obj1, obj2, obj3);
        assertContains(em.findAll(OneToOneTestClass.class), par1, par2, par3);
        assertContains(em.findAll(ManyToOneTestClass.class), grand1, grand2);
    }
}
